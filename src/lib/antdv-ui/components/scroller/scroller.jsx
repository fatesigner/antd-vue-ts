...
export default {
  ...
  render(h) {
    ...
    const view = h(
      this.tag,
      {
        class: ['as-scroller__view', this.viewClass],
    ...
    const wrap = (
      <div
        ...
        class={[this.wrapClass, 'as-scroller__wrap', gutter ? '' : 'as-scroller__wrap--hidden-default']}
      >
        {[view]}
      </div>
    );
    ...
    if (!this.native) {
      ...
      nodes = [
        <div ref='wrap' class={[this.wrapClass, 'as-scroller__wrap']} style={style}>
          {[view]}
        </div>
      ];
    }
    return h('div', { class: 'as-scroller' }, nodes);
  },
