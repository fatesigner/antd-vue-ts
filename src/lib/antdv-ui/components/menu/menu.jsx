...
import Menubar from './utils/aria-menubar';
...
export default {
  ...
  render(h) {
    const component = (
      <ul
        ...
        class={{
          ...
          'as-menu--collapse': this.collapse,
          'as-menu': true
        }}
      >
        {this.$slots.default}
    ...
    if (this.collapseTransition) {
      return <as-menu-collapse-transition>{component}</as-menu-collapse-transition>;
    } else {
      return component;
    }
  },

  componentName: 'AsMenu',
  ...
  components: {
    'as-menu-collapse-transition': {
      functional: true,
      render(createAsement, context) {
        const data = {
          props: {
            mode: 'out-in'
          },
          on: {
            ...
            enter(el) {
              addClass(el, 'as-opacity-transition');
              el.style.opacity = 1;
            },

            afterEnter(el) {
              removeClass(el, 'as-opacity-transition');
              el.style.opacity = '';
            },
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, 'as-menu--collapse')) {
                removeClass(el, 'as-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, 'as-menu--collapse');
              } else {
                addClass(el, 'as-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
        ...
        return createAsement('transition', data, context.children);
      }
    }
  },
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast('AsSubmenu', 'toggle-collapse', value);
    }
  },
  methods: {
      ...
      if (this.router && hasIndex) {
        this.routeToItem(item, (error) => {
          ...
          if (error) {
            ...
            // https://github.com/AsemeFE/element/issues/17044
